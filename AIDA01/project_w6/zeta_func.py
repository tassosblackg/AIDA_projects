...
p12_dif = za+zb
p12_sam = z1*zab
print("Persons 1-2 bayes factor = ",p12_dif,p12_sam,'\n')
...
p13_dif = za+zc
p13_sam = z1*zac
print("Persons 1-3 bayes factor = ",p13_dif/p13_sam,'\n')
...
p23_dif = zb+zc
p23_sam = z1*zbc
print("Persons 2-3 bayes factor = ",p23_dif/p23_sam,'\n')
...
p123_dif = za+zb+zc
p123_sam = z1*zabc
print("Persons 1-2-3 bayes factor = ",p123_dif/p123_sam,'\n')
